...
builder.Services.AddKeyedTransient<IAIConnector, GeminiConnector>(AIModels.GeminiFlashLite)
       ...
       .AddKeyedTransient<IAIConnector, OllamaConnector>(AIModels.Phi4Local)
       .AddKeyedTransient<IAIConnector, OllamaConnector>(AIModels.DeepSeekReasonerLocal)
       .AddKeyedTransient<IAIConnector, OllamaConnector>(AIModels.DevstralLocal)
       .AddKeyedTransient<IAIConnector, OllamaConnector>(AIModels.Gemma3Local)
       .AddKeyedTransient<IAIConnector, OllamaConnector>(AIModels.CodeLlamaLocal)
